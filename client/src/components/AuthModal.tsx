  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative glass-strong rounded-[1.75rem] sm:rounded-[2rem] p-6 sm:p-8 md:p-10 max-w-md w-full max-h-[calc(100dvh-2rem)] overflow-y-auto"
      >
        <button
          onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-3">
          ...
          {error && (
            <motion.div
              ...
              className="text-xs text-rose-200 bg-rose-500/10 border border-rose-400/20 rounded-xl p-3"
            >
              {error}
            </motion.div>
          )}
